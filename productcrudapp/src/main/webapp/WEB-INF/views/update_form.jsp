...
<h1 style=color:green class="text-center mb-3">CHANGE THE PRODUCT DETAILS</h1>

<form action="${pageContext.request.contextPath}/handle-product" method="post">

<input type="text" value="${p.productId }" name="productId">
